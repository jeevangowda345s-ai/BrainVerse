...
export const APP_THEMES: Record<ThemeSettings['palette'], ThemeConfig> = {
  ...
  pure_white: {
    id: 'pure_white',
    name: 'Pure White',
    description: 'Ultra crisp pure white background with electric blue & obsidian accents',
    mode: 'light',
    badgeColor: 'bg-blue-50 text-blue-700 border-blue-200',
    bgClass: 'bg-white text-slate-950',
    cardBgClass: 'bg-slate-50/90',
    cardBorderClass: 'border-slate-200',
    primaryTextClass: 'text-slate-950',
    secondaryTextClass: 'text-slate-600',
    accentTextClass: 'text-blue-600',
    accentBgClass: 'bg-blue-600',
    glowClass: 'shadow-[0_4px_25px_rgba(37,99,235,0.12)]',
    gradientHeader: 'from-blue-600 via-cyan-600 to-indigo-600',
    previewColors: ['#FFFFFF', '#F1F5F9', '#2563EB', '#0284C7']
  },
  soft_snow: {
    id: 'soft_snow',
    name: 'Soft Snow',
    description: 'Warm cream-white canvas with emerald green & golden accents',
    mode: 'light',
    badgeColor: 'bg-emerald-50 text-emerald-800 border-emerald-200',
    bgClass: 'bg-[#FBFBF9] text-slate-900',
    cardBgClass: 'bg-white',
    cardBorderClass: 'border-slate-200',
    primaryTextClass: 'text-slate-900',
    secondaryTextClass: 'text-slate-600',
    ...
    glowClass: 'shadow-[0_4px_20px_rgba(16,185,129,0.12)]',
    gradientHeader: 'from-emerald-600 via-teal-600 to-amber-600',
    previewColors: ['#FBFBF9', '#FFFFFF', '#059669', '#D97706']
  },
  sunset_ember: {
    id: 'sunset_ember',
    name: 'Sunset Ember',
