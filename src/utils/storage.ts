...
export const DEFAULT_USER: UserProfile = {
  id: 'user_101',
  name: 'Jeevu Explorer',
  username: 'jeevu_brainmaster',
  avatar: '🧠',
  avatarFrame: 'Neon Hexagon',
  title: 'Neural Architect',
  age: 24,
  occupation: 'Software Engineer',
  education: 'B.Tech / University',
  dailyGoalMins: 15,
  streak: 7,
  ...
  maxEnergy: 100,
  rank: 'Diamond Mind',
  goals: ['Improve Memory', 'Improve Focus', 'Improve Logic', 'Fast Math'],
  ratings: {
    memory: 1480,
    logic: 1520,
    focus: 1390,
  ...
  badges: ['First Victory', 'Memory Master', 'Logic Genius', '7-Day Streak', 'Math Wizard'],
  unlockedCosmetics: ['Neon Hexagon', 'Cyberpunk Theme', 'Gold Crown Avatar'],
  isPremium: true,
  isOnboarded: true,
};
...
export const DEFAULT_ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: 'a2',
    title: 'Memory Master',
    description: 'Reach Level 10 in Memory Matrix without errors.',
    icon: 'Brain',
    progress: 7,
    maxProgress: 10,
    unlocked: false,
  ...
  },
  {
    id: 'a5',
    title: 'Math Wizard',
    description: 'Score over 3,000 points in Mental Math challenge.',
    icon: 'Zap',
    progress: 1,
    maxProgress: 1,
    unlocked: true,
  ...
  },
  {
    id: 'a6',
    title: 'Speed Demon',
    description: 'Average under 400ms reaction time in Quick Decision.',
    icon: 'Gauge',
    progress: 380,
    maxProgress: 400,
    unlocked: true,
